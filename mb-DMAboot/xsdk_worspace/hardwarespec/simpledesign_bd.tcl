...
################################################################
# This is a generated script based on design: simpledesign
#
...
proc create_hier_cell_microblaze_0_local_memory { parentCell nameHier } {
  ...
  set ilmb_bram1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.2 ilmb_bram1 ]
  set_property -dict [ list CONFIG.Memory_Type {True_Dual_Port_RAM} CONFIG.use_bram_block {BRAM_Controller}  ] $ilmb_bram1

  # Create instance: ilmb_bram_if_cntlr, and set properties
  set ilmb_bram_if_cntlr [ create_bd_cell -type ip -vlnv xilinx.com:ip:lmb_bram_if_cntlr:4.0 ilmb_bram_if_cntlr ]
  set_property -dict [ list CONFIG.C_ECC {0} CONFIG.C_NUM_LMB {2}  ] $ilmb_bram_if_cntlr
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.MASTER_TYPE {BRAM_CTRL}  ] $BRAM_PORTB
  ...
  set_property -dict [ list CONFIG.C_ALL_OUTPUTS {1}  ] $out0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net BRAM_PORTB_1 [get_bd_intf_ports BRAM_PORTB] [get_bd_intf_pins microblaze_0_local_memory/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_uartlite_0_UART [get_bd_intf_ports uart_rtl] [get_bd_intf_pins axi_uartlite_0/UART]
  connect_bd_intf_net -intf_net in1_GPIO [get_bd_intf_ports gpio_rtl] [get_bd_intf_pins in1/GPIO]
  connect_bd_intf_net -intf_net in2_GPIO [get_bd_intf_ports gpio_rtl_0] [get_bd_intf_pins in2/GPIO]
  ...
  connect_bd_intf_net -intf_net out0_GPIO [get_bd_intf_ports gpio_rtl_1] [get_bd_intf_pins out0/GPIO]

  # Create port connections
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_Clk_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_ports Clk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins in1/s_axi_aclk] [get_bd_pins in2/s_axi_aclk] [get_bd_pins mdm_1/S_AXI_ACLK] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins out0/s_axi_aclk] [get_bd_pins rst_Clk_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_Clk_100M_peripheral_aresetn [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins in1/s_axi_aresetn] [get_bd_pins in2/s_axi_aresetn] [get_bd_pins mdm_1/S_AXI_ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins out0/s_axi_aresetn] [get_bd_pins rst_Clk_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x0 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs microblaze_0_local_memory/ilmb_bram_if_cntlr/SLMB1/Mem] SEG_ilmb_bram_if_cntlr_Mem
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs in1/S_AXI/Reg] SEG_in1_Reg
  create_bd_addr_seg -range 0x10000 -offset 0x40010000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs in2/S_AXI/Reg] SEG_in2_Reg
  ...
  create_bd_addr_seg -range 0x10000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs out0/S_AXI/Reg] SEG_out0_Reg
